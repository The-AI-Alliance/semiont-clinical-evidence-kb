...
- [Quick Start: Local](https://github.com/The-AI-Alliance/semiont-clinical-evidence-kb#quick-start-local) — run the Semiont stack on your machine via `.semiont/scripts/start.sh`
