 ...
 * for one evidence base) plus optional `context/` / `curated/` / `generated/`
 ...
 * articles become canonical ClinicalContext resources on day 1; downstream
 ...
 * a coherent published vocabulary for skills that target "every Drug" or
 * "every Trial".
 */
const KB_ENTITY_TYPES = [
  ...
  'ClinicalContext',
  'Curated',
  // mark-medical-entities entity types
  'Drug',
  'Condition',
  'Dose',
  'Outcome',
  ...
  'Intervention',
  'Comparator',
  // tag-pico entity types (interim — until a registered clinical-pico tag schema lands upstream)
  'PICO_Patient',
  'PICO_Intervention',
  'PICO_Comparison',
  'PICO_Outcome',
